...
public class SignupActivity extends AppCompatActivity {
    ...
    public void signup() {
        ...
        StringRequest request = new StringRequest(Request.Method.POST,"https://vetsforpets.000webhostapp.com/ajax_users_register.php", new Response.Listener<String>() {
            @Override
    ...
    public boolean validate() {
        ...
        if (mobile.isEmpty() || mobile.length() < 3) {
            _mobileText.setError("at least 3 characters");
            valid = false;
        } else {
