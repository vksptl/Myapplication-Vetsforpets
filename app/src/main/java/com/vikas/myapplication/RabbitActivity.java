...
public class RabbitActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imageList.add("http://hdwallpaperbackgrounds.net/wp-content/uploads/2015/10/Cute-Rabbit-HD-Wallpaper-Desktop-Backgrounds-1024x910.jpg");
        imageList.add("http://mosthdwallpapers.com/wp-content/uploads/2016/06/Cute-White-Rabbit-HD-Desktop-Background.jpg");
        ...
        b1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i= new Intent(RabbitActivity.this,Rabbit1.class);
                startActivity(i);
            }
        });
